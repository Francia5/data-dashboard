...
document.getElementById('students-inscribed-SCL2016').innerHTML = ("Cantidad de estudiantes inscritas SCL 2017 1: " + totalStudents);
...
// alumanas activas 
var totalTOTALSCL = data.AQP['2017-1'];
totalTOTALSCL = activeStudentsSCL(totalTOTALSCL);
document.getElementById('students-active-SCL2016').innerHTML = ("Cantidad de estudiantes activas SCL 2017 1: " + totalTOTALSCL);
...
document.getElementById('students-desertion-SCL2016').innerHTML = ("Cantidad de estudiantes desertoras SCL 2017 1: " + dropoutSCL);
...
// var hse = '';
// for(var j = 0; j < data.AQP['2017-1'].students[i].sprints.length; j++){    
//     tech += '<li>' + ("Sprint: " + " : " + (data.AQP['2017-1'].students[i].sprints[j].number) + " = " + (data.AQP['2017-1'].students[i].sprints[j].score.tech)); + '</li>';
// }
// document.getElementById('activeTECH').innerHTML = tech;


// for(var j = 0; j < data.AQP['2017-1'].students[i].sprints.length; j++){    
//     hse += '<li>' + ("Sprint: " + " : " + (data.AQP['2017-1'].students[i].sprints[j].number) + " = " + (data.AQP['2017-1'].students[i].sprints[j].score.hse)); + '</li>';
//     // break;    
// }
...
//alumnas inscritas (students)
var studentsInscribed = function students(data) {
    var studentsNumber = data.AQP['2017-1'].students.length;
    return studentsNumber;
}
...
// 2
for(var i = 0; i < data.AQP['2017-1'].ratings.length; i++){
    satisfied = data.AQP['2017-1'].ratings[1].student.cumple + data.AQP['2017-1'].ratings[1].student.supera;
    text1 = "El porcentaje de estudiantes satisfechas en el Sprint " + 2 + " fue de " + satisfied1;
};
document.getElementById('Text1').innerHTML = text1;
// 3
for(var i = 0; i < data.AQP['2017-1'].ratings.length; i++){
    satisfied = data.AQP['2017-1'].ratings[2].student.cumple + data.AQP['2017-1'].ratings[2].student.supera;
    text2 = "El porcentaje de estudiantes satisfechas en el Sprint " + 3 + " fue de " + satisfied2;
};
document.getElementById('Text2').innerHTML = text2;
// 4
for(var i = 0; i < data.AQP['2017-1'].ratings.length; i++){
    satisfied = data.AQP['2017-1'].ratings[3].student.cumple + data.AQP['2017-1'].ratings[3].student.supera;
